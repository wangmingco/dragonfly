package co.wangming.dragonfly.agent.core.matcher;
...
public class TypeMatcher<T extends TypeDescription> implements ElementMatcher.Junction<T> {
    ...
    public static <T extends TypeDescription> TypeMatcher<T> of(Junction<T> matcher) {
    ...
    public static class InnerTypeMatcher<T extends TypeDescription> extends AbstractBase<T> {
